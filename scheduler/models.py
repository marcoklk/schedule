...
class Schedule(models.Model):
    ...
    plan_day = models.ForeignKey(Shifts, on_delete=models.CASCADE, related_name='plan_id')
    done_day = models.ForeignKey(Shifts, on_delete=models.CASCADE, related_name='done_id')
